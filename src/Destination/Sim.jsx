    ...
    return(
        <div>
            <div className="h-screen bg-fixed bg-auto bg-no-repeat bg-[url('/Amd_Card.jpg')] flex flex-col">
                <Nav />
                <h1 className="mt-44 p-10 text-Scolor opacity-70 text-Title font-inter font-bold self-center">SIMLA</h1>
            </div>
            <div className="bg-Scolor text-Tcolor">
            <div className="p-10">
                <h1 className="text-8xl p-10 text-Fcolor font-semibold">Simla</h1>
